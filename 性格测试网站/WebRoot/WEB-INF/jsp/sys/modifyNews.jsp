				...
				<tr>
					<td colspan="2">
						<dl class="nowrap">
							<dt>图片：</dt>
							<dd>
								<img alt="" src="${ctx}/resource/${modifybean.imageFile}" width="120px" onerror="javascript:this.src='${ctx}/resource/no.jpg'"><br/>
								<input name="imageFile1" value="" type="file" class="" />
							</dd>
						</dl>
					</td>
				</tr>
