...
<form id="pagerForm" method="post" action="${ctx}/sys/queryQuesVote.do">
	<input type="hidden" name="pageNum" value="" />
</form>

<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="${ctx}/sys/queryQuesVote.do" method="post">
	<div class="searchBar">
		<table>
			<tr>
			<td><span style="margin-left: 5px">题目:</span><input  type="text" name="s_title" value=""/></td>
			<td><span style="margin-left: 5px">主题编号:</span><input  type="text" name="s_quesType.sid" value=""/></td>
			<td>
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="${ctx}/sys/add2QuesVote.do" target="navTab"  rel="baseAdd" title="添加信息"> <span>添加</span></a></li>
			<li><a class="edit" href="${ctx}/sys/getQuesVote.do?uid={sid_select}" target="navTab" rel="baseAdd" warn="请选择一条信息,点击需要修改的行" title="修改信息"><span>修改</span></a></li>
	...
	<table class="table" width="100%" layoutH="112">
		...
		<tbody>
			...
			<tr target="sid_select" rel="${item.id }">
				...
				<td width="70">
					<a title="详细信息"  href="${ctx}/sys/getQuesVote.do?uid=${item.id}" class="btnEdit" target="navTab" rel="baseAdd">详细信息</a>
