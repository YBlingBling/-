...
<h2 class="contentTitle">添加 投票主题 信息</h2>
<div class="pageContent">
	<form method="post" action="${ctx}/sys/addQuesVote.do" class="pageForm required-validate" enctype="multipart/form-data"
				...
				<tr>
					<td colspan="2">
						<dl>
							<dt>分类：</dt>
							<dd>
								<select name="quesType.voteType.id" class="">
