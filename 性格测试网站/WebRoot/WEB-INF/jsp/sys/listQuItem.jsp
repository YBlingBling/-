...
<div class="pageHeader">
	...
	<div class="searchBar">
		<table>
			<tr>
			<td><span style="margin-left: 5px">主题:</span><input  type="text" name="s_qu.title" value=""/></td>
			<td>
	...
	<table class="table" width="100%" layoutH="112">
		<thead>
			<tr>
				...
				<th width="100">问题</th>
				<th width="100">答案1</th>
				<th width="100">答案1分值</th>
				<th width="100">答案2</th>
				<th width="100">答案2分值</th>
				<th width="100">答案3</th>
				<th width="100">答案3分值</th>
				<th width="100">答案4</th>
				<th width="100">答案4分值</th>
