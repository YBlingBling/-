...
<h2 class="contentTitle">修改 问卷题目 信息</h2>
<div class="pageContent">
	<form method="post" action="${ctx}/sys/updateQues.do" class="pageForm required-validate" enctype="multipart/form-data"
				...
				<tr>
					<td colspan="2">
						<dl>
							<dt>题目分类：</dt>
							<dd>
								<select name="quesType.id" class="" id="updatesimple2222">
...
$("#updatesimple2222").val("${modifybean.quesType.id}");
