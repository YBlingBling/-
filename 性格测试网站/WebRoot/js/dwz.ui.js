...
function initUI(_box){
	...
	$("a[target=navTab]", $p).each(function(){
		$(this).click(function(event){
			...
			var icos = $this.children("i").attr("class") || "fa fa-cog fa-lg fa-fw";//注意这里，添加这一句，意思是，获取html属性icos，如果没有，就指定一个。 
			//alert(icos);
			...
			navTab.openTab(icos,tabid, url,{title:title, fresh:fresh, external:external});
