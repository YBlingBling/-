	...
	<div class="row" style="width:100%">
		<div class="12u" style="width:100%">
			...
			<nav class="mobileUI-site-nav" id="site-nav">
				<ul>
					<li id="menuli_index"><a href="${ctx}/com/index.do">首页</a></li>
					<li id="menuli_qu"><a href="${ctx}/com/listQu.do">趣味测试</a></li>
					<li id="menuli_list2"><a href="${ctx}/com/getQues.do">职业测试</a></li>
					<li id="menuli_news"><a href="${ctx}/com/queryNews.do">查询</a></li>
...
<div id="loginbox" style="display: none;width: 700px">
    ...
    <input type="hidden" value="" id="unsaved"/>
    <label>
    <span>账号 :</span>
...
function doLogin(){
	...
	$.ajax({
     		...
     		type:"post",
     		dataType:"json",
     		data:{"name":username,"password":password,"unsaved":unsaved},//window.encodeURI(中文值)：对字符串进行编码
     		success:function(json){
     			if(json.msg=='跳转'){
     				window.location.href="${ctx }/com/updateQuesCheckAfter.do";
     			}else if(json.msg=="成功"){
					layer.close(pageii);
